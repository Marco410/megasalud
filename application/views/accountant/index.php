<div class="container">
	...
	<div class="col-sm-12" >
        <div class="panel panel-default" >
            ...
            <div class="panel-body" >
                ...
                <div class="col-sm-3 text-center" >
                    <a  class="btn btn-info"  data-toggle="modal" data-target="#consultas"><i class="fa fa-clock-o "></i>  Consultas Clinicas</a>
                </div>  
            </div>
        </div>
    </div>
  ...
  <!-- Modal Agregar Historial citas -->
    ...
    <!--- Termina modal Historial citas --> 
     ...
     <div class="modal fade" id="consultas" tabindex="-1" role="dialog" aria-labelledby="fotoPerfil" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="fotoPerfil">Historial de Citas</h5>
            ...
            <div class="modal-body">
                ...
                <table id="consulta_table"  class="table table-striped"  style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Paciente</th>
