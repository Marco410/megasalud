<div class="container">
	...
	<div class="col-sm-12">
		<h3 class="ms-title"><b>NUEVA SALIDA</b> <a href="javascript:history.back()" class="btn btn-default pull-right"><i class="fa fa-chevron-left"></i> <span>Regresar</span></a></h3>
	</div>
    ...
    <div class="col-sm-12" >
        ...
        <div class="panel panel-olive" >
            <div class="panel-heading " >
                <h5>Generar nueva salida al almacén</h5>
            </div>
            <div class="panel-body" >
                <form method="post" name="form-salida-almacen" id="form-salida-almacen">
                <div class="col-sm-6" >
                    <label>Entregado A:</label>    
                    <input required class="form-control" type="text" name="entregado"  />
                </div> 
					...
					<tbody>
						<?php foreach ( $data as $almacen ): ?>
							<tr>
                                ...
                                <td><button onclick="agregar_ps('<?= $almacen->id ?>','<?= $almacen->nombre ?>','<?= $almacen->existencia ?>','<?= $almacen->clave_categoria ?>',this)"  class="btn btn-success "><span class="fa fa-plus" aria-hidden="true"></span></button>
                                </td>
