<div class="container">
	...
	<div class="col-sm-12">
		<h3 class="ms-title"><b>ENTRADAS - <?= $this->session->sucursal_name;?></b> <a href="javascript:history.back()" class="btn btn-default pull-right"><i class="fa fa-chevron-left"></i> <span>Regresar</span></a></h3>
	</div>
