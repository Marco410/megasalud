				...
				<div class="row">
                    ...
                    <div class="col-sm-12" >
                        ...
                        <canvas id="<?= $chart->titulo ?>"></canvas>
                         ...
                         <div class="col-sm-12 text-center" ><button class="btn btn-sm btn-danger btn_delete_chart" data="<?= $chart->id ?>" ><i class="fa fa-trash" ></i>Eliminar Gráfica</button></div>
                        </div>
            ...
            <div class="modal-body">
                ...
                <div class="row" >
                    ...
                    <div class="col-sm-12" >
                        ...
                        <input class="form-control" type="text" placeholder="Ingrese Descripcion" name="descripcion" required />
